...
const handleLogout = async (req, res) => {
    ...
    if (!foundUser) {
        res.clearCookie( 'jwt', { httpOnly: true, secure: true })// Setting "secure: true" in cookie will mean it only can be sent via https! Mess up testing etc
    ...
    res.clearCookie('jwt', { httpOnly: true, secure: true }) // To make sure this only occurs via https: Set secure: true - Only serves on https
